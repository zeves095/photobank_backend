...
Для тестов загрузки файлов на сервер в .env переменной TEST_UPLOAD_FILE_PATH должен быть определен путь к директории, в которой лежат файлы "1.jpg"-"4.jpg". Пример можно помотреть в .env.dist.
