...
Поиск реализован через методы *search([SearchObjectClass] SearchObject)* репозиториев Doctrine(*/src/Repository/*). Сам запрос в репозиторий отдает */src/Service/Search/SearchService*. Классы объектов поиска описаны в */src/Entity/Search/*.
