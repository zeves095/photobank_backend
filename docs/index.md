...
![alt text](./fileuploader-sequence.png)
...
![alt text](./link-create-sequence.png)
...
![alt text](./link-manager-init-sequence.png)

##### Создание ссылки

![alt text](./link-manager-create-sequence.png)

##### Удаление ссылки

![alt text](./link-manager-delete-sequence.png)
